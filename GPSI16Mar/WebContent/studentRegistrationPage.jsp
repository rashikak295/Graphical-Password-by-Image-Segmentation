...
<div class="row">
    ...
    %>
        ...
        <form class="form-basic" name="f1" method="post" enctype="multipart/form-data" action="GPSIStudentServlet" onsubmit="return validation()">
           ...
           <!--  <div class="form-title-row">
            ...
            <div class="form-row">
             ...
             <div class="form-row">
                <label>
                    ...
                    <input type="text" name="yearOfJoining" id="StartDate" value=""  required>
                </label>
            </div>
            ...
            <div class="form-row">
                <label>
                    ...
                    <input type="text" name="yearOfCompletion" id="EndDate" value=""  required>
                </label>
            </div>

...
GPSIRegistrationHODPojo gpsiRegistrationPojo=(GPSIRegistrationHODPojo)session.getAttribute("gpsiRegistrationPojo");
int kk=0;
...
<button class="btn-primary"><a href="hodLoginPage.jsp" style="font: 2opx bold; color: black;">Register</a></button>
</div>
<br>

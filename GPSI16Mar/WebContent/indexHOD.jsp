...
long hodid=(Long)sess.getAttribute("hodid");
			...
			try {
                ...
                if (!isAllowed(new File((String)ht.get("dir")), false)){
					...
					if (info != null && info.aborted) {
						...
						PreparedStatement ps=conn.prepareStatement("insert into hod_upload_file(upload_file_path,hod_username,upload_file,hod_id,deptName,userType) values(?,?,?,?,?,?)");

...
<%@page import="com.image.utility.AddFilesWithAESEncryption"%>
...
long studentId=(Long)sess.getAttribute("studentId");
...
<%
		...
		RESTRICT_PATH=Constant.USER_FILE_LOCATION+username;
			...
			try {
                ...
                if (!isAllowed(new File((String)ht.get("dir")), false)){
					...
					if (info != null && info.aborted) {
						...
						PreparedStatement ps=conn.prepareStatement("insert into student_upload_file(upload_file_path,student_username,upload_file,student_id,deptName,userType) values(?,?,?,?,?,?)");

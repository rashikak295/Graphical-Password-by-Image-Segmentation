...
<div id="dvSource" class="col-md-6">
 <%
List<ImageIndexPojo> imageList=(List<ImageIndexPojo>)session.getAttribute("imageIndexPojoList");
 System.out.println("imageListJSP::::"+imageList);

GPSIRegistrationStudentPojo gpsiRegistrationPojo=(GPSIRegistrationStudentPojo)session.getAttribute("gpsiRegistrationStudentPojo");
...
<!-- <form method="post" action="SaveStudentPasswordServlet">

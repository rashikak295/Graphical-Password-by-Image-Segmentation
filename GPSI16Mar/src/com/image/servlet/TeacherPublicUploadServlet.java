...
@WebServlet("/TeacherPublicUploadServlet")
@MultipartConfig(maxFileSize =1024*1024*100) // upload file up to 16MB
public class TeacherPublicUploadServlet extends HttpServlet {
	...
	public TeacherPublicUploadServlet() {
	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		...
		getServletContext().getRequestDispatcher("/indexTeacher.jsp").forward(
				request, response);
	}

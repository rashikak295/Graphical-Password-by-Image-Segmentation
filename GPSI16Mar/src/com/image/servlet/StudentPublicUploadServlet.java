...
/**
 * Servlet implementation class StudentPublicUploadServlet
 */
@WebServlet("/StudentPublicUploadServlet")
@MultipartConfig(maxFileSize =1024*1024*100) // upload file up to 16MB
public class StudentPublicUploadServlet extends HttpServlet {
	...
	public StudentPublicUploadServlet() {
	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		...
		getServletContext().getRequestDispatcher("/indexStudent.jsp").forward(
				request, response);
	}
